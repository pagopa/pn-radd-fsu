...
@ContextConfiguration(classes = {RegistryImportService.class})
class RegistryImportServiceTest {
    ...
    @BeforeEach
    void setUp() {
        registryImportService = new RegistryImportService(raddRegistryRequestDAO, raddRegistryDAO, raddRegistryImportDAO, pnSafeStorageClient, new RaddRegistryUtils(new ObjectMapperUtil(new com.fasterxml.jackson.databind.ObjectMapper()), pnRaddFsuConfig, secretService), pnAddressManagerClient);
    }
    ...
    void testUploadRegistryRequests() {
        ...
        StepVerifier.create(registryImportService.uploadRegistryRequests("cxId", Mono.just(request)))
    ...
    public void shouldProcessMessageSuccessfully() throws JsonProcessingException {
        ...
        Mono<Void> result = registryImportService.handleAddressManagerEvent(pnAddressManagerEvent);
    ...
    public void shouldProcessMessageSuccessfullyWithError() {
        ...
        Mono<Void> result = registryImportService.handleAddressManagerEvent(message);
    ...
    void testVerifyRegistryRequests_ValidCase() {
        ...
        StepVerifier.create(registryImportService.verifyRegistriesImportRequest("cxId", "requestId"))
    ...
    public void shouldHandleRequestSuccessfully() throws JsonProcessingException {
        ...
        StepVerifier.create(registryImportService.handleNormalizeRequestEvent(payload)).verifyComplete();
    }
}